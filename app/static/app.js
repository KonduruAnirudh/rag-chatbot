...
async function askQuestion(question) {
  ...
  pending.setAttribute("aria-label", "Waiting for answer");
  pending.append(loadingDots());
...
els.clearBtn.addEventListener("click", async () => {
  ...
  try {
    await api(`/api/chat/reset?session_id=${encodeURIComponent(sessionId)}`, { method: "POST" });
  } catch {
